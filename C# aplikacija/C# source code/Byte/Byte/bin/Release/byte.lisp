...
(defun heuristika (stanje igrac)
    (cond
        ((equalp igrac 'x) (list stanje (- (nth 1 stanje) (nth 2 stanje))))
        ((equalp igrac 'o) (list stanje (- (nth 2 stanje) (nth 1 stanje))))
    )
    ;; (cond
    ;;     ((equalp igrac 'x) (list stanje (nth 1 stanje)))
    ;;     ((equalp igrac 'o) (list stanje (nth 2 stanje)))
    ;; )
...
(defun izracunaj-potez-lista (lpoteza stanje1 stanje2)
    (cond
        ((null lpoteza) '())
	( (equalp (cekiraj-stanje (odigraj-potez stanje1 (car lpoteza))) stanje2) (car lpoteza))
...
(defun alpha-beta-potez (stanje igrac)
    (cond
        ((null (svi-potezi stanje igrac)) (format t "racunarnemapotez~%") stanje)
        (t
            (let*
                (
...
(defun main (igra)
    (let*
        (
            ...
            (novo-stanje
                (cond
                    ( (= (nth 1 igra) 1) (alpha-beta-potez stanje igrac))
